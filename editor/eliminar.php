<?php 
   ...
   if($_POST){
       ...
       $database->delete("tb_juego_config",[
...
<div id="divCodeWrapper">
    ...
    <form action="./eliminar.php" method="POST">
        ...
        position:absolute; width:15%; bottom:1px; background: red; color: white;
        font-size: 18px; height:40px; z-index: 1; right: 50px;" type="submit" value="Eliminar">
    </form>
</div>
