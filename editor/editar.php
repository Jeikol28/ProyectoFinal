...
if($_POST){
    ...
    $database->update("tb_juego_config", [
    "data_juego" => $_POST['data'],
    "actualizado" => date("Y-m-d H:i:s")
    ],[
        "id_juego_config" => $_POST['id']
    ]);
...
<body>
    ...
    <div id="divCodeWrapper">
        ...
        <form action="./editar.php" method="POST">
            <textarea id="textarea1" wrap="soft" spellcheck="false" name="data" 
            style="color: white">
            <?php 
                echo $data[0]['data_juego'];
            ?>
            </textarea>
            <input type="hidden" name="id" value="<?php echo $_GET['id']; ?>">
            <input type="submit" value="Agregar" style="display: block; position: absolute; width: 15%; bottom: 1px; 
            background:red;color:white; font-size: 18px; height: 40px;z-index: 10; right: 50px; top: 500px;">
        </form>
